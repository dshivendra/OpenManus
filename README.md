...
This repository includes a sample `mcp.json` populated with around sixty-five
community servers using their GitHub URLs as placeholders. Replace those URLs with the
